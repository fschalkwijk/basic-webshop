        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="app-navbar-collapse">
                ...
                <ul class="nav navbar-nav">
                    <li><a href="{{ action('HomeController@index') }}">Producten</a></li>
                    @if(Auth::check())
                    <li><a href="{{ action('OrderController@index') }}">Bestellingen</a></li>
                    @endif
                </ul>
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    @if (Auth::guest())
                        ...
                        <li><a href="{{ action('Auth\AuthController@register') }}">Aanmelden</a></li>
                    @else
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="{{ action('Auth\AuthController@logout') }}"><i class="fa fa-btn fa-sign-out"></i>Loguit</a></li>
                            </ul>
                        </li>
                    @endif
                </ul>
